...
import { decode, encode } from "https://deno.land/std/ws/../strings/mod.ts";

type Conn = Deno.Conn;
type Writer = Deno.Writer;
import { BufReader, BufWriter, EOF, UnexpectedEOFError } from "https://deno.land/std/ws/../io/bufio.ts";
import { readLong, readShort, sliceLongToBytes } from "https://deno.land/std/ws/../io/ioutil.ts";
import { Sha1 } from "https://deno.land/std/ws/./sha1.ts";
import { writeResponse } from "https://deno.land/std/ws/../http/server.ts";
import { TextProtoReader } from "https://deno.land/std/ws/../textproto/mod.ts";
